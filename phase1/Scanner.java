...
class Scanner {
        ...
        public static void main(String args[]) throws IOException {
                ...
                class Token {
                        ...
                        public void print() {
                                if (tokenIdentifier.equals("INT_LITERAL") || tokenIdentifier.equals("FLOAT_LITERAL")
                                                || tokenIdentifier.equals("IDENTIFIER")) {
                ...
                for (int i = 0; i < input.length(); i++) {
                        ...
                        if (output == 99) {
                                ...
                                if (finalStates.get(currentState).equals("INT_LITERAL")
                                                || finalStates.get(currentState).equals("FLOAT_LITERAL")) {
                ...
                if (finalStates.get(currentState) != null) {
                        ...
                        if ((finalStates.get(currentState).equals("INT_LITERAL")
                                        || finalStates.get(currentState).equals("FLOAT_LITERAL"))
                                        && symDictionary.get(currentChar) < 26) {
